  ...
  <div class="container-fluid py-4">
    ...
    <div class="row mb-5">
      <div class="col-12 text-center">
        <h1 class="display-4 fw-bold text-primary mb-3">Collector.shop</h1>
        <p class="lead text-muted mb-4">La marketplace des objets vintage entre passionnés</p>
        <div class="row justify-content-center g-3">
          <div class="col-md-4 col-lg-3">
            <button class="btn btn-primary btn-lg w-100">Parcourir le catalogue</button>
          </div>
          <div class="col-md-4 col-lg-3">
            <button class="btn btn-outline-secondary btn-lg w-100">Devenir vendeur</button>
          </div>
        </div>
      </div>
    </div>
