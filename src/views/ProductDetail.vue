...
const mockDetail: Product = {
  ...
  description: "État exceptionnel, boîte d'origine incluse. Taille 42 EU, jamais portée en extérieur.",
  price: 285,
  category: 'Sneakers',
  condition: 'like_new',
...
<template>
  <div v-if="loading" class="container py-5">
    <div class="spinner-border text-primary mx-auto d-block" style="width: 3rem; height: 3rem;"></div>
  </div>
      ...
      <div class="col-lg-6">
        <div class="sticky-top" style="top: 20px;">
          ...
          <div class="d-flex align-items-baseline mb-4">
            ...
            <span class="badge bg-warning text-dark ms-3 fs-6">{{ product.rarity?.toUpperCase() }}</span>
          </div>

          <div class="mb-4">
            <h6 class="text-muted mb-2">État</h6>
            <span class="badge bg-success fs-6 px-3 py-2">{{ product.condition.replace('_', ' ') }}</span>
          </div>
